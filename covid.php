        ...
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center">
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/kar/map.jpg" alt="Image Placeholder" class="img-fluid"></a>
                 
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">KARNATAKA ANALYSIS</h3>
        ...
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            ...
            <ul class="list-unstyled footer-link d-flex footer-social">
              <li><a href="#" class="p-2" style="color: darkslateblue"><span class="fa fa-twitter"></span></a></li>
              <li><a href="#" class="p-2"style="color: darkslateblue"><span class="fa fa-facebook"></span></a></li>
              <li><a href="#" class="p-2"style="color: darkslateblue"><span class="fa fa-linkedin"></span></a></li>
              <li><a href="#" class="p-2"style="color: darkslateblue"><span class="fa fa-instagram"></span></a></li>
            </ul>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey"style="color: darkslateblue">Address:</span>
                  <span style="color: darkslateblue">34 Street Name, Karnataka, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: darkslateblue" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: darkslateblue">Email:</span><span>info@krntka.com</span></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3 mb-5">
            ...
            <ul class="list-unstyled footer-link">
              <li><a href="#"style="color: darkslateblue">About</a></li>
              <li><a href="#"style="color: darkslateblue">Terms of Use</a></li>
              <li><a href="#"style="color: darkslateblue">Disclaimers</a></li>
              <li><a href="#"style="color: darkslateblue">Contact</a></li>
            </ul>
          </div>
          <div class="col-md-3">
