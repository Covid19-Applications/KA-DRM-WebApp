        ...
        <use xlink:href="#wave-path" x="50" y="9" fill="#fff">
                    ...
                    <div class="whole-wrap">
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Orphanages & Services for Vulnerable Citizens In Karnataka</h2>
                                  <?php
                                  $query = "SELECT * FROM orphans where state='karnataka'";
