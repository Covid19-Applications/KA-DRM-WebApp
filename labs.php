...
<!-- ======= Features Section ======= -->
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              ...
              <h4 class="d-none d-lg-block">COVID KARNATAKA UPDATES</h4>
            </a>
          </li>
        </ul>
 ...
 <button id="mapsbtn">TESTING LABS</button></a>
         ...
         <iframe src="https://www.google.co.in/maps/d/embed?mid=1YMovW5FPiVBGXhh7O-KOunOV6EuG757v" width="640" height="480"></iframe>
              </div>
            </div>
...
<div class="container table-responsive">
  ...
  <h1 style="text-align: center;">DAILY-RECORDS OF TESTING IN KARNATAKA</h1>
